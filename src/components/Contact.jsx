  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
      {
        ...
        to_email: 'aleexandra.junges@gmail.com',
        ...
        >
          <label className="flex flex-col">
            ...
            <input
              ...
              className="bg-primary py-4 px-6 placeholder:text-blue text-blue rounded-lg outlined-none border-none font-medium"
            />
          </label>
          ...
          <button
            type="submit"
            className="bg-secondary py-3 px-8 rounded-xl outline-none w-fit text-white font-bold shadow-md shadow-secondary"
          >
